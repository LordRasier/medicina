...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Editar <span class="fw-300"><i>Profesional</i></span>
                </h2>
            </div>
            <div class="panel-container show">
                <div class="panel-content">
                    <form action="/users/{{$edit->id}}/update" method="POST">
                        <div class="row">
                            @csrf
                            @method("PUT")
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-6 mb-15">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" name="ingreso" type="text" class="calendar-event-date @error("ingreso") is-invalid @enderror form-control" value="{{$edit->ingreso}}" maxlength="40" value="{{old("ingreso")}}" placeholder="01/12/2007" required>
                                    ...
                                    <div class="col-6 mb-15">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" name="graduacion" type="text" class="calendar-event-date @error("graduacion") is-invalid @enderror form-control" value="{{$edit->graduacion}}" maxlength="40" value="{{old("graduacion")}}" placeholder="01/12/2007" required>
                                    ...
                                    <div class="col-3 mb-15">
                                        <div class="form-group">
                                            ...
                                            <input name="horas" type="text" class="@error("horas") is-invalid @enderror form-control" value="{{$edit->horas}}" maxlength="3" value="{{old("horas")}}" placeholder="horas" required>

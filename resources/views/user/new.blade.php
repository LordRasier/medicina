                                ...
                                <div class="row">
                                    <div class="col-6 mb-15">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" name="ingreso" type="text" class="calendar-event-date @error("ingreso") is-invalid @enderror form-control" maxlength="40" value="{{old("ingreso")}}" placeholder="01/12/2007" required>
